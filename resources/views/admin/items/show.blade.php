            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ App\Models\Item::CHAMPS_SELECT[$item->champs] ?? '' }}
                        </td>
                    </tr>
                    <tr>
                        <th>
...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#items_gabarits" role="tab" data-toggle="tab">
                {{ trans('cruds.gabarit.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="items_gabarits">
            @includeIf('admin.items.relationships.itemsGabarits', ['gabarits' => $item->itemsGabarits])
        </div>
    </div>
</div>
