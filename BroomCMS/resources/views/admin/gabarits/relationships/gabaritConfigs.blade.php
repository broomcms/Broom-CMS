    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-gabaritConfigs">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($configs as $key => $config)
                            <tr data-entry-id="{{ $config->id }}">
                                ...
                                <td>
                                    @foreach($config->gabarits as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-gabaritConfigs:not(.ajaxTable)').DataTable({ buttons: dtButtons })
