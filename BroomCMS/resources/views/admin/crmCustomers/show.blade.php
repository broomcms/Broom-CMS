        ...
        <div class="form-group">
            ...
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    <tr>
                        <th>
                            {{ trans('cruds.crmCustomer.fields.utilisateur') }}
                        </th>
                        <td>
                            {{ $crmCustomer->utilisateur->name ?? '' }}
                        </td>
                    </tr>
                </tbody>
            </table>
...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#client_commandes" role="tab" data-toggle="tab">
                {{ trans('cruds.commande.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="client_commandes">
            @includeIf('admin.crmCustomers.relationships.clientCommandes', ['commandes' => $crmCustomer->clientCommandes])
        </div>
    </div>
</div>
